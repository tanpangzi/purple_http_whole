...
import com.zimi.zimixing.activity.zmxGpsInstall.GPSLoadingActivity;
    ...
    public View getItemView(final int position, View convertView, ViewHolder holder) {
        ...
        if (TextUtils.isEmpty(bean.getUrl())) {
            ...
            if (!path.startsWith("/storage/emulated") && !path.startsWith("http")) {
                path = ConfigServer.SERVER_API_URL + path;
            }
        ...
        iv_select_pic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(bean.getUrl())) {
                    ...
                    }else*/ if (context instanceof GPSLoadingActivity){
                        ((GPSLoadingActivity) context).showChoseDialog();
                    }
                } else {
                    /*if (context instanceof CarAssememtActivity) { //车辆评估
                        ...
                        ((GPSLoadingActivity) context).gotoPreviewPhoto(position);
                    }
                }
            }
        });
