...
public class GPSBean extends BaseBean implements Serializable {
    /**
     * isCounterProduct : 1
    ...
    protected void init(JSONObject jSon) throws JSONException {
        ...
        returnList = (ArrayList<ReturnListBean>) BaseBean.toModelList(jSon.optString("returnList", ""), ReturnListBean.class);
    }

    public static class ReturnListBean extends BaseBean implements Serializable {
        /**
         * accState : 0
        ...
        @Override
        protected void init(JSONObject jSon) throws JSONException {
            onlineStatus = jSon.optInt("onlineStatus", 0);
            type = jSon.optInt("type", 0);
            speed = jSon.optInt("speed", 0);
            batteryCapacity = jSon.optInt("batteryCapacity", 0);
            locationState = jSon.optInt("locationState", 0);
            receiveDate = jSon.optString("receiveDate","");
            gpsSignalIntensity = jSon.optInt("gpsSignalIntensity", 0);
            gsmSignalIntensity = jSon.optInt("gsmSignalIntensity", 0);

            accState = jSon.optString("accState", "");
            serviceDate = jSon.optString("serviceDate", "");
            color = jSon.optString("accState", "");
            latitude = jSon.optString("latitude", "");
            phoneNum = jSon.optString("phoneNum", "");
            stateLength = jSon.optString("stateLength", "");
            ...
            locationDate = jSon.optString("locationDate", "");
            gpsOrGms = jSon.optString("gpsOrGms", "");
