//package com.hxyd.dyt.utils.picasso;
//
...
// */
//public class CropOtherTransformation implements Transformation {
...
//     * @param height
//     *         in pixels
//     * @param gravityHorizontal
//     *         position of the cropped area within the larger source image
//     * @param gravityVertical
//     *         position of the cropped area within the larger source image
//     */
//    public CropOtherTransformation(int width, int height, GravityHorizontal gravityHorizontal,
...
//     *         in pixels
//     */
//    public CropOtherTransformation(int width, int height) {
...
//     *
//     * @param widthRatio
//     *         width of the target image relative to the width of the source image; 1 =
//     *         100%
//     * @param heightRatio
//     *         height of the target image relative to the height of the source image; 1 =
//     *         100%
//     * @param gravityHorizontal
//     *         position of the cropped area within the larger source image
//     * @param gravityVertical
//     *         position of the cropped area within the larger source image
//     */
//    public CropOtherTransformation(float widthRatio, float heightRatio,
...
//     *         in pixels, one of width/height should be zero
//     * @param aspectRatio
//     *         width/height: greater than 1 is landscape, less than 1 is portrait, 1 is
//     *         square
//     * @param gravityHorizontal
//     *         position of the cropped area within the larger source image
//     * @param gravityVertical
//     *         position of the cropped area within the larger source image
//     */
//    public CropOtherTransformation(int width, int height, float aspectRatio,
//                                   GravityHorizontal gravityHorizontal, GravityVertical gravityVertical) {
//        mWidth = width;
//        mHeight = height;
...
//     * the center/center:
//     * CropOtherTransformation(0.5, (float)0, (float)16/9, CENTER, CENTER);
//     *
//     * @param widthRatio
//     *         width of the target image relative to the width of the source image; 1 =
//     *         100%
...
//     *         position of the cropped area within the larger source image
//     */
//    public CropOtherTransformation(float widthRatio, float heightRatio, float aspectRatio,
//                                   GravityHorizontal gravityHorizontal, GravityVertical gravityVertical) {
//        mWidthRatio = widthRatio;
//        mHeightRatio = heightRatio;
//        mAspectRatio = aspectRatio;
...
//     *         position of the cropped area within the larger source image
//     */
//    public CropOtherTransformation(float aspectRatio, GravityHorizontal gravityHorizontal,
//                                   GravityVertical gravityVertical) {
//        mAspectRatio = aspectRatio;
//        mGravityHorizontal = gravityHorizontal;
//        mGravityVertical = gravityVertical;
...
//    @Override
//    public String key() {
//        return "CropOtherTransformation(width=" + mWidth + ", height=" + mHeight + ", mWidthRatio="
