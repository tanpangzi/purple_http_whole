...
public class PreferencesUtil {
    ...
    //	 * @return sp数据操作工具类
    //	 */
    //	public static synchronized PreferencesUtil getSpUtil() {
    //		if (spUtil == null) {
    //			spUtil = new PreferencesUtil();
    //		}
    //		return spUtil;
    //	}
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = context.getSharedPreferences(ConstantKey.SP_FILE_NAME, Context.MODE_PRIVATE);
    ...
    public static void putObject(String fileKey, Object obj) {
        ...
        SharedPreferences sp = context.getSharedPreferences(ConstantKey.SP_FILE_NAME, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
        try {
