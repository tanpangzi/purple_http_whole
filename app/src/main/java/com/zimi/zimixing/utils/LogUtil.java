...
import com.zimi.zimixing.bean.OperaBean;
...
public class LogUtil {
     ...
     *         json格式字符串
     */
    public static void json(String method, String json) {
        if (IS_SHOW_LOG) {
            ...
            try {
                ...
                try {
                    ...
                    Log.i(TAG, formatStr(method, json));
                    return;
                }
            }
     ...
     * <p>
     * <br> Version: 1.0.0
     * <br> CreateTime: 2016-12-15,下午1:56:09
     * <br> UpdateTime: 2016-12-15,下午1:56:09
     * <br> CreateAuthor: 叶青
     * <br> UpdateAuthor: 叶青
     * <br> UpdateInfo: (此处输入修改内容,若无修改可不写.)
     *
     ...
     * <p>
     * <br> Version: 1.0.0
     * <br> CreateTime: 2016-12-15,下午1:56:00
     * <br> UpdateTime: 2016-12-15,下午1:56:00
     * <br> CreateAuthor: 叶青
     * <br> UpdateAuthor: 叶青
     * <br> UpdateInfo: (此处输入修改内容,若无修改可不写.)
     *
    ...
    public static void saveErrorLog(String errorStr) {
        ...
        if(!PermissionUtils.getInstance().checkSelfPermission(BaseApplication.getInstance().getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            return;
        }
        // StackTraceElement stackTraceElement =
        // Thread.currentThread().getStackTrace()[3];
        String info = getLogInfo() + errorStr;

        OperaBean opBean = new OperaBean();
        // <!-- **********************错误日志*********************** -->
        info = "机型 :" + opBean.getPhoneModel() + info + "\n";
        info = "时间 :" + opBean.getTime() + info + "\n";
        info = "系统版本 :" + opBean.getRomVersion() + info + "\n";
        info = "系统类型 :" + opBean.getSystemType() + info + "\n";
        info = "正式版本" + opBean.getVersionCode() + info + "\n";

        // 向本地写入错误日志.
        try {
            FileWriter fw = new FileWriter(ConfigFile.PATH_LOG + System.currentTimeMillis() + ".txt");
            fw.flush();
            fw.write(info);
            fw.close();
        } catch (Exception e) {
