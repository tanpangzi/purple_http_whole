...
import com.zimi.zimixing.widget.CustomToast;
...
public class ToastUtil {
    ...
    private static void show(Context context, String text, int duration) {
        if (null == context || EmptyCheckUtil.isEmpty(text, true)) {
            return;
        }
     ...
     * <p>
     * <br> Version: 1.0.0
     * <br> CreateTime: 2016-12-24,下午8:41:57
     * <br> UpdateTime: 2016-12-24,下午8:41:57
     * <br> CreateAuthor: 叶青
     * <br> UpdateAuthor: 叶青
     * <br> UpdateInfo: (此处输入修改内容,若无修改可不写.)
     *
     ...
     *         提示信息
     * @param gravity
     *         android.view.Gravity(位置TOP BOTTOM LEFT RIGHT)
     * @param xOffset
     *         屏幕左上角为(0,0)
     * @param yOffset
     *         屏幕左上角为(0,0)
    ...
    public static void showToast(Context context, String text, int gravity, int xOffset, int yOffset, int duration) {
        ...
        CustomToast customToast = new CustomToast(context, gravity, xOffset, yOffset, duration);
