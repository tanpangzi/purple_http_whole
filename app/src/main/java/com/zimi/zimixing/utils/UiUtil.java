...
public class UiUtil {
    ...
    public static void startActivityWithAuth(Context context, Class clazz, Bundle bundle) {
        startActivity(context, clazz, bundle);
    }

    public static void startActivityForResultWithAuth(Activity activity, Class clazz, int requestCode, Bundle bundle) {
        startActivityForResult(activity, clazz, requestCode, bundle);
    }
