...
public class SystemUtil {
    ...
    public static String getAppLanguage() {
        return (String) PreferencesUtil.get(ConstantKey.SP_KEY_FILE_LANGUAGE, SystemUtil.getSystemLanguage());
    }
    ...
    public static void openGpsSetting(final Context context) {
        ...
        DialogUtil.showMessageDg(context, context.getString(R.string.notifyTitle),
                context.getString(R.string.gpsNotifyMsg),
                "取消",
                "确认",
                new CustomDialog.OnDialogClickListener() {
                    ...
                    public void onClick(CustomDialog dialog, int id, Object object) {
                        ...
                        ((Activity)context).startActivityForResult(intent, RequestCode.REQUEST_CODE_OPENGPS);
                        dialog.dismiss();
                    }
                });
    }
