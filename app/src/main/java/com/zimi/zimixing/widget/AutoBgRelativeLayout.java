...
import com.zimi.zimixing.utils.BitmapUtil;
import com.zimi.zimixing.utils.LogUtil;

/**
 * 自定义LinearLayout自带点击效果
 * <p>
 * <br> Author: 叶青
 * <br> Version: 1.0.0
 * <br> Date: 2016/12/12
...
public class AutoBgRelativeLayout extends RelativeLayout {
    ...
    public AutoBgRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public AutoBgRelativeLayout(Context context, AttributeSet attrs) {
        ...
        // 圆角的大小 默认为3dp
        //bgRadius = a.getDimensionPixelSize(R.styleable.AutoBg_bgRadius,  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, getResources().getDisplayMetrics()));
        bgRadius = a.getDimensionPixelSize(R.styleable.AutoBg_bgRadius,  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, getResources().getDisplayMetrics()));
        // 点击后的透明度
