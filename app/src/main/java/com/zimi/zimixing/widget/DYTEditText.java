...
public class DYTEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    public DYTEditText(Context context) {
        this(context, null);
    }

    public DYTEditText(Context context, AttributeSet attrs) {
        //这里构造方法也很重要，不加这个很多属性不能再XML里面定义
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public DYTEditText(Context context, AttributeSet attrs, int defStyle) {
