 ...
 */
public class TitleViewPurple extends LinearLayout {
    ...
    public TitleViewPurple(Context context) {
        super(context);
        init(context);
    }

    public TitleViewPurple(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TitleViewPurple(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        viewParent = View.inflate(context, R.layout.view_title_purple, null);
    ...
    public void setOnTitleListener(OnClickListener listener) {
        Drawable drawable = getResources().getDrawable(R.drawable.arrow_left_black);
