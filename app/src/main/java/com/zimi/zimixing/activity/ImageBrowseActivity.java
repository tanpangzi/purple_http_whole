...
import com.zimi.zimixing.biz.OrderBiz;
...
import com.zimi.zimixing.widget.CustomViewPager4Lock;
...
public class ImageBrowseActivity extends BaseActivity {
    ...
    protected void findViews() {
        ...
        viewPager = (CustomViewPager4Lock) findViewById(R.id.view_pager);
        //        titleview.setBgColor(R.color.black,R.color.white);
    }
    ...
    @Override
    protected void init() {
        //titleview.setTitle(getString(R.string.activity_image_browse));
        initViewPage();
    }
                ...
                if (imgPath.get(i).contains("storage/emulated")) {
                   ...
                   /* if (path.startsWith("common")){
                    ...
                    if (!path.contains("/app/") && index != -1){
                        path = ConfigServer.SERVER_API_URL + "/app/" + path.substring(index, path.length());
                    }
    ...
    private void deleteImg() {
        RequestExecutor.addTask(new BaseTask(ImageBrowseActivity.this, "删除中请稍候", false) {
            ...
            public ResponseBean sendRequest() {
                ...
                return OrderBiz.deleteImg(custId, fileName);
            }
    ...
    private void deleteImg4(){
        RequestExecutor.addTask(new BaseTask(ImageBrowseActivity.this, "删除中请稍候", false) {
            ...
            public ResponseBean sendRequest() {
                ...
                return InstallBiz.deleteImg(imgType, fileName, imeiId);
            }
    ...
    private void setDel(int position) {
        //if (!TextUtils.isEmpty(businessId)) {
            if (TextUtils.isEmpty(imgPath.get(position))) {
                ...
                titleview.setRightBtnImg(R.drawable.delete_iamge, new OnClickListener() {
