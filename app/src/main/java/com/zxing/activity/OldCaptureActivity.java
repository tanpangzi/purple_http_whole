...
// * <br> Date: 2016年12月11日
// */
//public class OldCaptureActivity extends BaseActivity implements Callback {
//
//    /** 选择本地二维码图---返回返回码 */
...
//     *         图片资源
//     *
//     * @Version: 1.0 CreateTime: 2016-4-9,上午10:08:37 UpdateTime:
//     * 2016-4-9,上午10:08:37 CreateAuthor: 叶青 UpdateAuthor: 叶青 UpdateInfo:
//     * (此处输入修改内容,若无修改可不�?.)
//     */
...
//            Toast.makeText(OldCaptureActivity.this, "barcode!=null", Toast.LENGTH_SHORT).show();
//        }
//        if (result != null) {
...
//                Toast.makeText(OldCaptureActivity.this, getString(R.string.scan_failed_tips), Toast.LENGTH_SHORT).show();
//            } else {
//                //                TODO 拿到结果 做处理
//                Toast.makeText(OldCaptureActivity.this, resultString, Toast.LENGTH_SHORT).show();
//            }
//        } else {
//            Toast.makeText(OldCaptureActivity.this, getString(R.string.scan_failed_tips), Toast.LENGTH_SHORT).show();
//        }
...
//            switch (requestCode) {
//                case SELECT_PICTURE_CODE:// 图库选择图片后返�?
//
//                    if (data != null) {
...
//        try {
//            return reader.decrypt(bitmap1, hints);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//     * 扫描完成是播放声音加震动
//     *
//     * @Version: 1.0 CreateTime: 2016-4-9,上午10:06:56 UpdateTime:
//     * 2016-4-9,上午10:06:56 CreateAuthor: 叶青 UpdateAuthor: 叶青 UpdateInfo:
//     * (此处输入修改内容,若无修改可不�?.)
//     */
