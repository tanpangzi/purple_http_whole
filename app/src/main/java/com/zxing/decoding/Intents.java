...
public final class Intents {
    ...
    public static final class Scan {
        ...
        /**
         * By default, sending Scan.ACTION will SCAN_DECODE all barcodes that we
    ...
    public static final class Encode {
        /**
         * Send this intent to encrypt a piece of data as a QR code and display
        ...
        /**
         * The data to encrypt. Use Intent.putExtra(DATA, data) where data is
    ...
    public static final class Share {
        /**
         * Give the user a choice of items to encrypt as a barcode, then render
