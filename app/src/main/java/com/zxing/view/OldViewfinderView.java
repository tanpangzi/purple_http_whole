...
public final class OldViewfinderView extends View {
	/** 点点的个�? */
	private static final int RESULT_POINT_SIZE = 5;
	/** 刷新界面的时�? */
	private static final long ANIMATION_DELAY = 10L;
	/** 透明�?40% */
	private static final int OPAQUE = 0x6f;
	/** 四个绿色边角对应的长�? */
	...
	public OldViewfinderView(Context context, AttributeSet attrs) {
		super(context, attrs);

		// density = context.getResources().getDisplayMetrics().density;
		// 将像素转换成dp
		ScreenRate = ScreenUtil.dip2px(15);

		paint = new Paint();
		Resources resources = getResources();
		maskColor = resources.getColor(R.color.black_40);
		resultColor = resources.getColor(R.color.black_70);
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			// HashSet<ResultPoint>(RESULT_POINT_SIZE);
